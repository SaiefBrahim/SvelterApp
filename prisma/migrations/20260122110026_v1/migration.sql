...
CREATE TABLE "tax_identifiers" (
    ...
    CONSTRAINT "tax_identifiers_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "tax_identifiers_organization_settings_id_idx" ON "tax_identifiers"("organization_settings_id");
...
-- AddForeignKey
ALTER TABLE "tax_identifiers" ADD CONSTRAINT "tax_identifiers_organization_settings_id_fkey" FOREIGN KEY ("organization_settings_id") REFERENCES "organization_settings"("id") ON DELETE CASCADE ON UPDATE CASCADE;
